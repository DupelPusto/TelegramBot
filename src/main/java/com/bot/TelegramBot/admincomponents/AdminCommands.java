...
public class AdminCommands {
    public static final String ADD_STUDENT = "/student_add";
    ...
    public static final String SHOW_SCHEDULE = "/schedule_show";
    public static final String SHOW_COMMANDS = "/++";
    public static final String BROADCAST = "/broadcast_message";
